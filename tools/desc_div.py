...
def extract_weights(text, class_names):
    ...
    for class_name in class_names:
        ...
        # Example: "Background Matching (Object-Self): 0.25"
        ...
        for line in lines:
            ...
            if match:
                ...
                weights[class_name] = float(match.group(2))
...
for desc_path in desc_list:
    with open(desc_path) as json_file:
        ...
        try:
            ...
            weights_single_line = extract_weights(attribute_contribution, class_names)
